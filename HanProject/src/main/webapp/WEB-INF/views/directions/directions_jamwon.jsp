...
<body>
	...
	<div id="view_directions" >
		...
		<table summary="버스로 오실 때 하차하는 정류장을 안내하는 표. 하차정류장명, 버스번호, 도보로 이용 가능한 접근로명, 정류장~접근로거리로 구성.">
			...
			<tbody>
				<tr>
					...
					<td >143, 351, 362, 440, 472, 3011, 4318, 4412, 4419, 6010</td>
					<td>
						강남나들목<br />
						(강남육갑문)
					</td>
				...
				<tr>
					...
					<td>140,142,144, 241A, 241B, 402, 407, 408, 420, 421, 470, 471, 472, 3011</td>
					<td>계단 및 엘리베이터</td>
					<td>50m</td>
				</tr>
			</tbody>
		...
		<p>지하철로 오실 때는</p>
		<ul>
			<li>3호선 신사역 5번 출구(1,000m)</li>
			<li>3호선 압구정역 1번 출구 (800m)</li>
		</ul>
